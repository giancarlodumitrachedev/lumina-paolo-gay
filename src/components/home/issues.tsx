...
const issues = [
  { title: "Dipendenze", description: "Percorsi strutturati per il trattamento e l'uscita da dipendenze da sostanze o comportamentali.", icon: <ShieldAlert className="w-6 h-6" /> },
  { title: "Disagi Psichiatrici", description: "Trattamento clinico profondo, con forte esperienza maturata nei Centri di Salute Mentale.", icon: <Brain className="w-6 h-6" /> },
  { title: "Problematiche Adolescenziali", description: "Sostegno specifico per i giovani e le loro famiglie durante le fasi critiche dello sviluppo.", icon: <HeartPulse className="w-6 h-6" /> }
];
