...
const services = [
  { title: "Psicoterapia Psicoanalitica", description: "Trattamento profondo dei disturbi contemporanei con un approccio clinico consolidato.", icon: <UserCircle className="w-8 h-8" /> },
  { title: "Conduzione di Gruppi", description: "Percorsi terapeutici di gruppo per favorire la condivisione e il supporto reciproco.", icon: <Users className="w-8 h-8" /> },
  { title: "Sostegno Familiare", description: "Lavoro congiunto con i familiari di adolescenti per ristabilire dinamiche comunicative funzionali.", icon: <Activity className="w-8 h-8" /> }
];
