...
const faqs = [
  { question: "In cosa consiste l'approccio psicoanalitico contemporaneo?", answer: "È un approccio che mira all'esplorazione profonda del sé, ricercando le cause inconsce della sofferenza declinandolo per i disturbi attuali." },
  { question: "Tratta solo adulti o anche giovani?", answer: "Lavoro molto attivamente anche con adolescenti problematici e offro supporto specifico ai loro familiari." }
];
